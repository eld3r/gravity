...
{
    [TestClass]
    public class DoublePassCombinatorTests
    {
        ...
        {
            target = new DoublePassCombinator<object>();
        }
        ...
        {
            List<object> list = Enumerable.Range(0, 100).Cast<object>().ToList();
